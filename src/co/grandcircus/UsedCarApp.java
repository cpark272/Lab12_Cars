...
public class UsedCarApp {
	...
	public static void main(String[] args) {
		...
		usedCarList.add(new UsedCar("Nikolai", "Model S", 2017, 54999.90, 0));
		usedCarList.add(new UsedCar("Fourd", "Escapade", 2017, 31999.90, 0));
		usedCarList.add(new UsedCar("Chewie", "Vette", 2017, 44989.95, 0));
